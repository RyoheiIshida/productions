...
class OrdersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'stocks_id' => ['type' => 'index', 'columns' => ['stocks_id'], 'length' => []],
            'productions_id' => ['type' => 'index', 'columns' => ['productions_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'orders_ibfk_1' => ['type' => 'foreign', 'columns' => ['stocks_id'], 'references' => ['stocks', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'orders_ibfk_2' => ['type' => 'foreign', 'columns' => ['productions_id'], 'references' => ['productions', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
